...
$CONFIG = [
    ...
    "RANDOM_KEY" => 'kyJ8ojyRMM6eS4Zk', // Random key for encryption
    ...
    "USER_EMAIL_FIELD_NAME" => "username",
    ...
    "UPLOAD_ALLOWED_FILE_EXT" => "jpg,jpeg,png,pdf", // Allowed file extensions
