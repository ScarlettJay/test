 ...
 * Page class
 */
class ApplicantsDelete extends Applicants
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ApplicantsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ApplicantsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("ApplicantsList"); // Return to list
                return;
            }
        }
