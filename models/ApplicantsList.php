 ...
 * Page class
 */
class ApplicantsList extends Applicants
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ApplicantsList";
    ...
    public $FormName = "fapplicantslist";
    ...
    public function __construct()
    {
        ...
        // Initialize URLs
        $this->AddUrl = "ApplicantsAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "ApplicantsDelete";
        $this->MultiUpdateUrl = "ApplicantsUpdate";
    ...
    public function run()
    {
        ...
        $this->applicant_id->setVisibility();
    ...
    public function getFilterList()
    {
        ...
        $filterList = "";
        $savedFilterList = "";
        $filterList = Concat($filterList, $this->applicant_id->AdvancedSearch->toJson(), ","); // Field applicant_id
        ...
        $filterList = Concat($filterList, $this->ic_number->AdvancedSearch->toJson(), ","); // Field ic_number
        $filterList = Concat($filterList, $this->_email->AdvancedSearch->toJson(), ","); // Field email
        $filterList = Concat($filterList, $this->phone_number->AdvancedSearch->toJson(), ","); // Field phone_number
        $filterList = Concat($filterList, $this->education_level->AdvancedSearch->toJson(), ","); // Field education_level
        $filterList = Concat($filterList, $this->job_position->AdvancedSearch->toJson(), ","); // Field job_position
        $filterList = Concat($filterList, $this->certificate->AdvancedSearch->toJson(), ","); // Field certificate
        $filterList = Concat($filterList, $this->application_date->AdvancedSearch->toJson(), ","); // Field application_date
        if ($this->BasicSearch->Keyword != "") {
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fapplicantssrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field applicant_id
        $this->applicant_id->AdvancedSearch->SearchValue = @$filter["x_applicant_id"];
        $this->applicant_id->AdvancedSearch->SearchOperator = @$filter["z_applicant_id"];
        $this->applicant_id->AdvancedSearch->SearchCondition = @$filter["v_applicant_id"];
        $this->applicant_id->AdvancedSearch->SearchValue2 = @$filter["y_applicant_id"];
        $this->applicant_id->AdvancedSearch->SearchOperator2 = @$filter["w_applicant_id"];
        $this->applicant_id->AdvancedSearch->save();
        ...
        // Field ic_number
        $this->ic_number->AdvancedSearch->SearchValue = @$filter["x_ic_number"];
        $this->ic_number->AdvancedSearch->SearchOperator = @$filter["z_ic_number"];
        $this->ic_number->AdvancedSearch->SearchCondition = @$filter["v_ic_number"];
        $this->ic_number->AdvancedSearch->SearchValue2 = @$filter["y_ic_number"];
        $this->ic_number->AdvancedSearch->SearchOperator2 = @$filter["w_ic_number"];
        $this->ic_number->AdvancedSearch->save();
        ...
        $this->education_level->AdvancedSearch->SearchValue = @$filter["x_education_level"];
        $this->education_level->AdvancedSearch->SearchOperator = @$filter["z_education_level"];
        $this->education_level->AdvancedSearch->SearchCondition = @$filter["v_education_level"];
        $this->education_level->AdvancedSearch->SearchValue2 = @$filter["y_education_level"];
        $this->education_level->AdvancedSearch->SearchOperator2 = @$filter["w_education_level"];
        $this->education_level->AdvancedSearch->save();

        // Field job_position
        $this->job_position->AdvancedSearch->SearchValue = @$filter["x_job_position"];
        $this->job_position->AdvancedSearch->SearchOperator = @$filter["z_job_position"];
        $this->job_position->AdvancedSearch->SearchCondition = @$filter["v_job_position"];
        $this->job_position->AdvancedSearch->SearchValue2 = @$filter["y_job_position"];
        $this->job_position->AdvancedSearch->SearchOperator2 = @$filter["w_job_position"];
        $this->job_position->AdvancedSearch->save();
        ...
        $this->application_date->AdvancedSearch->SearchValue = @$filter["x_application_date"];
        $this->application_date->AdvancedSearch->SearchOperator = @$filter["z_application_date"];
        $this->application_date->AdvancedSearch->SearchCondition = @$filter["v_application_date"];
        $this->application_date->AdvancedSearch->SearchValue2 = @$filter["y_application_date"];
        $this->application_date->AdvancedSearch->SearchOperator2 = @$filter["w_application_date"];
        $this->application_date->AdvancedSearch->save();
    ...
    protected function basicSearchWhere($default = false)
    {
        ...
        $searchFlds[] = &$this->ic_number;
        $searchFlds[] = &$this->_email;
        $searchFlds[] = &$this->phone_number;
        $searchFlds[] = &$this->education_level;
        $searchFlds[] = &$this->job_position;
        $searchFlds[] = &$this->certificate;
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->applicant_id); // applicant_id
            $this->updateSort($this->registration_id); // registration_id
            $this->updateSort($this->full_name); // full_name
            $this->updateSort($this->ic_number); // ic_number
            $this->updateSort($this->_email); // email
            $this->updateSort($this->phone_number); // phone_number
            $this->updateSort($this->education_level); // education_level
            $this->updateSort($this->job_position); // job_position
            $this->updateSort($this->application_date); // application_date
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                $orderBy = "";
                $this->setSessionOrderBy($orderBy);
                $this->applicant_id->setSort("");
                $this->registration_id->setSort("");
                $this->full_name->setSort("");
                $this->photo->setSort("");
                $this->ic_number->setSort("");
                $this->_email->setSort("");
                $this->phone_number->setSort("");
                $this->education_level->setSort("");
                $this->job_position->setSort("");
                $this->certificate->setSort("");
                $this->application_date->setSort("");
            }
    ...
    public function renderListOptions()
    {
        ...
        if ($opt && !$this->isExport() && !$this->CurrentAction) {
            ...
            foreach ($this->ListActions->Items as $listaction) {
                ...
                if ($listaction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    $link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"fapplicantslist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button></li>";
                    if ($link != "") {
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"fapplicantslist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button>";
                        }
                    }
                }
            }
        ...
        $opt->Body = "<div class=\"form-check\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"form-check-input ew-multi-select\" value=\"" . HtmlEncode($this->applicant_id->CurrentValue) . "\" data-ew-action=\"select-key\"></div>";
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<button type=\"button\" class=\"ew-action ew-multi-delete\" title=\"" . HtmlTitle($Language->phrase("DeleteSelectedLink")) . "\" data-caption=\"" . HtmlTitle($Language->phrase("DeleteSelectedLink")) . "\" form=\"fapplicantslist\" data-ew-action=\"submit\" data-url=\"" . GetUrl($this->MultiDeleteUrl) . "\"data-data='{\"action\":\"show\"}'>" . $Language->phrase("DeleteSelectedLink") . "</button>";
        $item->Visible = $Security->canDelete();
        ...
        if ($this->UseColumnVisibility) {
            ...
            $option->add("applicant_id", $this->createColumnOption("applicant_id"));
            $option->add("registration_id", $this->createColumnOption("registration_id"));
            $option->add("full_name", $this->createColumnOption("full_name"));
            $option->add("ic_number", $this->createColumnOption("ic_number"));
            $option->add("email", $this->createColumnOption("email"));
            $option->add("phone_number", $this->createColumnOption("phone_number"));
            $option->add("education_level", $this->createColumnOption("education_level"));
            $option->add("job_position", $this->createColumnOption("job_position"));
            $option->add("application_date", $this->createColumnOption("application_date"));
        }
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fapplicantssrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fapplicantssrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fapplicantslist"' . $listaction->toDataAttrs() . '>' . $icon . '</button>';
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            // applicant_id
            $this->applicant_id->LinkCustomAttributes = "";
            $this->applicant_id->HrefValue = "";
            $this->applicant_id->TooltipValue = "";
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" form="fapplicantslist" data-ew-action="email" data-hdr="' . $Language->phrase("ExportToEmailText") . '" data-sel="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fapplicantssrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
