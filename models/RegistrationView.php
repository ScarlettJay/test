...
class RegistrationView extends Registration
{
    ...
    // Page object name
    public $PageObjName = "RegistrationView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("registration_id") ?? Route("registration_id")) !== null) {
            $this->RecKey["registration_id"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (Get("registration_id") !== null) {
            ...
            $ExportFileName .= Get("registration_id");
        }
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("registration_id") ?? Route("registration_id")) !== null) {
                $this->registration_id->setQueryStringValue($keyValue);
                ...
                $returnUrl = "RegistrationList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "RegistrationList"; // No matching record, return to list
                        }
                    break;
            }
            ...
            $returnUrl = "RegistrationList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    */
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("RegistrationList"), "", $this->TableVar, true);
        $pageId = "view";
