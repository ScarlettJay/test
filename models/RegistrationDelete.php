 ...
 * Page class
 */
class RegistrationDelete extends Registration
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RegistrationDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("RegistrationList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("RegistrationList"); // Return to list
                return;
            }
        }
