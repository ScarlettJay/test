...
class ApplicantsView extends Applicants
{
    ...
    // Page object name
    public $PageObjName = "ApplicantsView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("applicant_id") ?? Route("applicant_id")) !== null) {
            $this->RecKey["applicant_id"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (Get("applicant_id") !== null) {
            if ($ExportFileName != "") {
                $ExportFileName .= "_";
            }
            $ExportFileName .= Get("applicant_id");
        }
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("applicant_id") ?? Route("applicant_id")) !== null) {
                ...
                $this->RecKey["applicant_id"] = $this->applicant_id->QueryStringValue;
            } elseif (Post("applicant_id") !== null) {
                $this->applicant_id->setFormValue(Post("applicant_id"));
                $this->RecKey["applicant_id"] = $this->applicant_id->FormValue;
            } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
                $this->applicant_id->setQueryStringValue($keyValue);
                $this->RecKey["applicant_id"] = $this->applicant_id->QueryStringValue;
            } else {
                $returnUrl = "ApplicantsList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "ApplicantsList"; // No matching record, return to list
                        }
                    break;
            }
            ...
            $returnUrl = "ApplicantsList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
