...
<?php } ?>
<link rel="shortcut icon" type="image/x-icon" href="<?= BasePath() ?>/PLlogo.ico">
<link rel="icon" type="image/x-icon" href="<?= BasePath() ?>/PLlogo.ico">
...
<div class="wrapper ew-layout">
    ...
    <nav class="<?= Config("NAVBAR_CLASS") ?>">
        <div class="container-fluid">
            ...
            <ul id="ew-navbar" class="navbar-nav">
                ...
                <a class="navbar-brand d-none" href="Parkland Group ">
                    <img src="<?= GetUrl("images/PLlogo.png") ?>" alt="" class="brand-image ew-brand-image">
                </a>
            </ul>
            <!-- Right navbar links -->
    ...
    <aside class="<?= Config("SIDEBAR_CLASS") ?>">
        <div class="brand-container">
            ...
            <a href="Parkland Group " class="brand-link">
                <img src="<?= GetUrl("images/PLlogo.png") ?>" alt="" class="brand-image ew-brand-image">
            </a>
